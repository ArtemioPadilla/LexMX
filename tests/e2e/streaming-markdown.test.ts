...
test.describe('Chat Streaming and Markdown', () => {
  test.beforeEach(async ({ page }) => {
    ...
    // Click on "Empezar" button to go to chat
  ...
  test('should render markdown content correctly', async ({ page }) => {
    ...
    // Configure WebLLM provider (it's free and works in browser)
    await page.click('text=WebLLM (Browser)');
...
test.describe('WebLLM Progress Indicator', () => {
  test('should show progress when downloading WebLLM model', async ({ page }) => {
    ...
    const progressIndicator = page.locator('text=Descargando modelo IA');
